...
![](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/fastlane.png)
...
touch Fastfile
```
![目录结构](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/目录结构.png)
...
![cocoapods](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/cocoapods.png)
点进去可以看到具体的使用及参数说明

![使用说明](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/使用说明.png)
...
fastlane lanes
```
![Fastfile验证成功](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/Fastfile验证成功.png)

### 3、执行fastlane

**需要在组件仓库的根目录下执行**
![根目录](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/根目录.png)


```
fastlane LXFUpdatePodTool tag:0.1.1 specName:LXFMain
```
![开始执行](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/开始执行.png)

![上传完成](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/上传完成.png)
...
```
按要求输入Action名称
![输入action名称](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/输入action名称.png)

完成后fastlane目录下就会多出一个名为actions的文件夹，里面存放的就是你自定义action
![](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/actions文件夹.png)
...
```
![查看具体描述](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/查看具体描述.png)
...
git tag
```
![已存在的tag](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/已存在的tag.png)

可以看到，我是已经有一个`0.1.1`版本的了。这时我们再来执行一次LXFUpdatePodTool航道
```
fastlane LXFUpdatePodTool tag:0.1.1 specName:LXFMain
```
![自动清除](/images/2018/04/iOS 组件化开发（四）：fastlane实现pod自动化/自动清除.png)
